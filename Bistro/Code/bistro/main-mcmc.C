...
// Read in initial tree topology
  ...
  cerr << "burn-in:" << endl;
  tree.mcmc(q_init,alignment,parameters.getNumBootstrap(),alignment.getNumSites(),rng,treeStream,parStream);
  cerr << endl << " done." << endl;
  ...
  // mcmc
  cerr << "sampling:" << endl;
  tree.mcmc(q_init,alignment,parameters.getNumRandom(),alignment.getNumSites(),rng,treeStream,parStream);
  cerr << endl << " done." << endl;
