...
## ================= simulations2 ============================================
path=""
dat1 = read.table(paste0(path,"weights1-5-nice.txt"), header=FALSE, sep=",")
dat2 = read.table(paste0(path,"weights6-10-nice.txt"), header=FALSE, sep=",")
dat3 = read.table(paste0(path,"weights11-15-nice.txt"), header=FALSE, sep=",")
dat4 = read.table(paste0(path,"weights16-20-nice.txt"), header=FALSE, sep=",")
