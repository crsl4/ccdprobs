...
public class CentroidMain {
	...
	public static void main(String[] args) {		
		...
		if (permute) {
			...
			System.out.println("Permutating leaves of input trees.");
		}
		...
		if (algorithm.equals("random") && !twoRuns) {
			getCentroidViaRandomCauchy(trees,numIter,cauchyLength,epsilon,outfile,displayIter);
		}
		else if (algorithm.equals("random") && twoRuns) {
			getCentroidViaRandomTwoRuns(trees,numIter,cauchyLength,epsilon,outfile,displayIter);
		}
		...
		// then chooses a new random order of the trees for the next round
			...
			getCentroidViaRandPermTwoRuns(trees,numIter,cauchyLength,epsilon,outfile,displayIter);
		}
		else if( algorithm.equals("rand_perm") && !twoRuns ) {
			getCentroidViaRandPermCauchy(trees,numIter,cauchyLength,epsilon,outfile,displayIter);
		}
		else {
	 ...
	 * @return
	 */
	public static PhyloTree getCentroidViaRandPermCauchy(PhyloTree[] trees, int numIter, int cauchyLength, double epsilon,String outfile, int displayIter) {
	...
	public static PhyloTree getCentroidViaRandomCauchy(PhyloTree[] trees, long numIter, int cauchyLength, double epsilon, String outfile, int displayIter) {
		DecimalFormat d6o = new DecimalFormat("#0.######");
		Boolean converge = false;
		int numTrees = trees.length;
	...
	public static PhyloTree getCentroidViaRandomTwoRuns(PhyloTree[] trees,int numIter, int matchLength, double epsilon,String outfile, int displayIter) {
		DecimalFormat d6o = new DecimalFormat("#0.######");
		Boolean converge = false;
		int numTrees = trees.length;
	...
	public static PhyloTree getCentroidViaRandPermTwoRuns(PhyloTree[] trees,int numIter, int matchLength,double epsilon, String outfile, int displayIter) {
		DecimalFormat d6o = new DecimalFormat("#0.######");
		Boolean converge = false;
		int numTrees = trees.length;
		int convergenceCounter = 0;  // counts number of times the two runs are within epsilon of each other
