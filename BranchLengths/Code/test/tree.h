...
public:
  ...
  void partialPathCalculations1D(double t1, double sum1, double sum2, Alignment& alignment,Node* nx,Edge* ex,Node* ny,Edge* ey,Node* nz,Edge* ez,QMatrix& qmatrix,double& logl,double& dlogl,double& ddlogl,bool recurse, bool verbose);
  ...
  double mleDistance(Alignment&,Node*,Edge*,Node*,Edge*,QMatrix&, bool);
  void mleDistanceJoint(Alignment& alignment,Node* nx,Edge* ex,Node* ny,Edge* ey,Node* nz,Edge* ez,QMatrix& qmatrix, double& lx, double& ly, double& lz, double sxy, double sxz, double syz,bool,bool,bool,mt19937_64& rng, bool, bool, ofstream&,ofstream&);
  void mleDistance2D(Alignment& alignment,Node* nx,Edge* ex,Node* ny,Edge* ey,Node* nz,Edge* ez,QMatrix& qmatrix, double& t1, double& t2, double& t3, double& sum, mt19937_64& rng, bool,bool, ofstream&);
  void mleDistance3D(Alignment& alignment,Node* nx,Edge* ex,Node* ny,Edge* ey,Node* nz,Edge* ez,QMatrix& qmatrix, double& lx, double& ly, double& lz, mt19937_64& rng, bool,bool, ofstream&);
  void mleDistance1D(Alignment& alignment,Node* nx,Edge* ex,Node* ny,Edge* ey,Node* nz,Edge* ez,QMatrix& qmatrix, double& t1, double& t2, double& t3, double& sum1, double& sum2, mt19937_64& rng, bool,bool);
  double maxPosteriorDistance(Alignment&,Node*,Edge*,Node*,Edge*,QMatrix&,double);
  void setNodeLevels();
  void depthFirstNodeList(list<Node*>&);
  void setActiveChildrenAndNodeParents();
  void generateBranchLengths(Alignment&,QMatrix&,mt19937_64& rng, bool,bool, ofstream&, ofstream&);
